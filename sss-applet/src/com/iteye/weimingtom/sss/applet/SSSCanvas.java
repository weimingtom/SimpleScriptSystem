...
public class SSSCanvas {
	...
	public static void init(Applet applet) {
		if (bufGraph == null) {
			bufImage = applet.createImage(SSSConfig.WINDOW_WIDTH,
		...
		if (bufGraph != null) {
			bufGraph.clearRect(0, 0, SSSConfig.WINDOW_WIDTH,
					SSSConfig.WINDOW_HEIGHT);
		}
	}
	...
	//FIXME:
	public static void canvasFillRect(int x1, int y1, int x2, int y2) {
		if (bufGraph != null) {
			bufGraph.fillRect(x1, y1, x2 - x1 + 1, y2 - y1 + 1);
		}
	}
}
