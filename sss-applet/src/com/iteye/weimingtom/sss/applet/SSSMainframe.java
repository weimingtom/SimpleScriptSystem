...
public class SSSMainframe extends Applet implements Runnable, KeyListener, MouseListener, MouseMotionListener{
    private static final long serialVersionUID = -6776404354323666713L;
    
    //for test
    private static final boolean ENABLE_SCRIPT = true;
	...
	SSSMainframe.mainframeResize(SSSConfig.WINDOW_WIDTH, SSSConfig.WINDOW_HEIGHT);
    ...
    /**
     * Applet start here.
     * the size is specified by environment.
     */
    @Override
    public void init() {
	if (mainframe == null) {
